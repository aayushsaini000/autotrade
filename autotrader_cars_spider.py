...
class AutoTraderSpider(scrapy.Spider):
    ...
    def parse_item_detail(self, response):
        ...
        item['Body_Type'] = json_response['vehicle']['keyFacts'].get('body-type')
        item['Fuel_Type'] = json_response['vehicle']['keyFacts'].get('fuel-type')
...
def run_spider(no_of_threads, request_delay, timeout):
    settings = {
        ...
        'ITEM_PIPELINES': {
            'pipelines_cars.AutoTraderCarExtractPipeline': 300,
        },
